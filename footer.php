    ...
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="sm:col-span-2">
            <a href="#" class="inline-flex items-center">
                ...
                <span class="ml-2 text-xl font-bold tracking-wide text-gray-800">EASY SHOPYYYYY</span>
            </a>
            <div class="mt-6 lg:max-w-xl">
                <p class="text-sm text-gray-800">
                Welcome to our Product Availability App, where you can easily explore and check the availability of a wide range of products in real-time. Whether you're looking for the latest gadgets, home essentials, or fashion items, our app provides up-to-date stock information and detailed product descriptions. Explore now and make informed decisions before you shop! 
                    </p>
            </div>
        </div>
